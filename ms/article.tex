...
In recent years, we have seen an explosive growth of digitized historical newspapers. Innovations in natural language processing have extended the possibilities for historians to extract information from large corpora of digitized historical texts. One of the sources that has been digitized extensively is newspapers. National libraries and project such as Impresso, Newseye, and Oceanic Exchanges offer access to digitized archives of historical newspapers.\footnote{\url{https://impresso-project.ch/}, \url{https://www.newseye.eu/}, \url{https://oceanicexchanges.org/}}
